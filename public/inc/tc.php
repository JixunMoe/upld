...
<div class="box">
	...
	<p>You must not use <?= SITE_NAME ?> to upload any of the following:</p>
	...
	<p>Things to note when using <?= SITE_NAME ?>:</p>
	...
	<ul class="tc">
		...
		<li><?= SITE_NAME ?> has the right to remove any images at it's discretion</li>
	</ul>
